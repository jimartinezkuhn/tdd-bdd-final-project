...
class Product(db.Model):
    ...
    def deserialize(self, data: dict):
        ...
        try:
            ...
            # Fix: Wrap Decimal conversion to catch syntax errors and raise DataValidationError
            try:
                self.price = Decimal(data["price"])
            except (TypeError, InvalidOperation) as error:  # Catch the error as 'error'
                raise DataValidationError(
                    "Invalid price: " + str(data["price"])
                ) from error
